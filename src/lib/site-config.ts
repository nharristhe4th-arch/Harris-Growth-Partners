// Central place for the details you're most likely to want to change later.
export const siteConfig = {
  name: "Harris Growth Partners",
  tagline: "Outbound growth systems for local service businesses",
  description:
